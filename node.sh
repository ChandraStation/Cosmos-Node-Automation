...
options=("Arch Linux" "Ubuntu" "Os is set up" "Quit")

select_option "${options[@]}"
choice=$?

echo "Choosen OS = $options"
...
#Starting Progress Bar
            ...
            sed -i 's/minimum-gas-prices = ""/minimum-gas-prices = "0.025uhuahua"/g' ~/.chihuahua/config/app.toml ||
            ...
            sudo systemctl start chihuahua ||
            printf '\nFinished!\n';;

...
#Akash cont...
            ...
            sudo rm ~/.akash/config/genesis.json 
...
EOF
            ...
            wget https://snapshots.stake2.me/chihuahua/chihuahua_2022-02-21.tar -P ~/.chihuahua/data
            tar -xvf ~/.chihuahua/data/chihuahua_2022-02-21.tar
...
EOF
            rm -rf .comdex/data/
            wget https://cosmos-snap.staketab.com/comdex -P ~/.chihuahua/data
            tar -xvf ~/.comdex/data/comdex
            sudo systemctl daemon-reload
...
EOF
            rm -rf .emd/data/
            wget u250245-sub1@rsync.stakesystems.io:emoney/.emd/data/ -P ~/.chihuahua/data
            tar -xvf ~/.emd/data/
            sudo systemctl daemon-reload 
...
EOF
            ...
            wget https://snapshots.stake2.me/chihuahua/chihuahua_2022-02-21.tar -P ~/.omniflixhub/data
            tar -xvf ~/.omniflixhub/data/chihuahua_2022-02-21.tar
            sudo systemctl daemon-reload 
...
EOF
            rm -rf .osmosis/data/
            wget https://snapshots.stake2.me/osmosis/osmosis_2022-02-20.tar -P ~/.osmosis/data
            tar -xvf ~/.osmosis/data/osmosis_2022-02-20.tar
            sudo systemctl daemon-reload
...
EOF
            ...
            wget http://135.181.60.250:8083/sentinel/sentinelhub-2_2022-02-21.tar -P ~/.sentinelhub/data
            tar -xvf ~/.sentinelhub/data/sentinelhub-2_2022-02-21.tar
            sudo systemctl daemon-reload 
